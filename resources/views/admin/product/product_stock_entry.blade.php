  ...
  <div class="clearfix"></div>
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>{{ $product->product_name }}: Price Setup</h2>
            <div class="clearfix"></div>
          </div>
          <div class="x_content"><br />
            ...
            <form method="POST" autocomplete="off" action="{{ route('admin.add_stock_entry', ['product_id' => encrypt($product->id)]) }}" class="form-horizontal form-label-left" enctype="multipart/form-data">
                @csrf
