                ...
                <div class="x_panel">
                  <div class="x_content">
                    <div class="row">
                      ...
                      <div class="clearfix"></div>
					  <form action="{{ route('admin.upload_product_slider', ['product_id' => $product_record[0]->id]) }}" method="POST" enctype="multipart/form-data" autocomplete="off">
						@csrf
						@method('PUT')
                                    ...
                                    <div class="well profile_view">
                                      <div class="col-sm-12">
                                        <div class="left col-xs-7">
											<a href="{{ route('admin.remove_product_slider_image', ['image_id' => $value->id ]) }}" class="btn btn-danger">Remove</a>
                                            <img src="{{ route('admin.additional_image', ['additional_image_id' => encrypt($value->id) ]) }}" style="width: 290px;" id="img">
                                        </div>
                                      </div>
                                      <div class="col-xs-12 bottom text-center">
                                        <form method="POST" autocomplete="off" action="{{ route('admin.update_product_additional_image', ['additional_image_id' => encrypt($value->id) ]) }}" enctype="multipart/form-data">
                                        @method('PUT')
                                        @csrf
